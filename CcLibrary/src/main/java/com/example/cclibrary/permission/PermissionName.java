...
public class PermissionName {
    ...
    private static void init() {
        ...
        permissionName.put(RECORD_AUDIO, "语音");
        permissionName.put(READ_EXTERNAL_STORAGE, "存储");
        permissionName.put(WRITE_EXTERNAL_STORAGE, "存储");
        permissionName.put(ACCESS_FINE_LOCATION, "获取精确位置");
        permissionName.put(ACCESS_FINE_LOCATION, "获取精确位置");
        permissionName.put(CALL_PHONE, "电话");
        permissionName.put(READ_PHONE_STATE, "手机状态");
    }
